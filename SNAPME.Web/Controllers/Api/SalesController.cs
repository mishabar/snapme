...
namespace SNAPME.Web.Controllers.Api
{
    ...
    public class SalesController : ApiController
    {
        ...
        private static Sale[] sales = new Sale[] {
                    ...
                    new Sale{ id =  "1234567891", name =  "Intel NUC", banner_image_url = "http://www.techzone.lk/wp-content/uploads/2014/11/up18.png", banner_url = "http://www.gadgetreview.com/wp-content/uploads/2013/09/TV-Watching.jpg", image_url =  "http://www.techzone.lk/wp-content/uploads/2014/11/up18.png", msrp =  499.99, target =  129.99, price = 499.99, drops =  0, progress =  0, summary = "Stunning visuals and edge-of-your-seat performance in an ultra-small package.", likes = true, favors = true, has_activity = false, is_featured = true, points = 15 },
                    new Sale{ id =  "1234567892", name =  "KitchenAid Stand Mixer", image_url =  "http://www.theproductpedia.com/wp-content/uploads/2013/11/kitchenaid-stand-mixer.jpg", msrp =  125.00, target =  79.00, price =  125.00, drops =  0, progress =  0, summary = "Versatility to help you with any recipe!", likes = false, favors = false, has_activity = false, is_featured = false, points = 10 },
        ...
        [Route("sales/featured"), HttpGet]
        public IHttpActionResult ListFeatured(ListProductsRequest request)
        {
            return Ok(new { a = User.Identity.IsAuthenticated, sales = sales.Where(s => s.is_featured) });
        }
    }
}
